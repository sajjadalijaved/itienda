...
class BottomBarBusinessOwner extends StatefulWidget {
  final int tabIndex;
  final BuildContext context;
  final List<String> icons;
  final List<String> lables;
  const BottomBarBusinessOwner(
      {Key? key,
  ...
  @override
  State<BottomBarBusinessOwner> createState() => _BottomBarState();
}

class _BottomBarState extends State<BottomBarBusinessOwner> {
  @override
